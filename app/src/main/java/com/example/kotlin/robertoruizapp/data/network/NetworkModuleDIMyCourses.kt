...
object NetworkModuleDIMyCourses {
    ...
    /**
     * Gets an instance of [MyCoursesApiService] configured with the base URL, client OkHttpClient
     * with Gson authentication token and converter.
     *
     * @return Instance of [MyCoursesApiService].
     */
    operator fun invoke(): MyCoursesApiService {
        return Retrofit.Builder()
            .baseUrl(Constants.BASE_URL)
            .client(okHttpClient)
            .addConverterFactory(gsonFactory)
            .build()
            .create(MyCoursesApiService::class.java)
    }
}